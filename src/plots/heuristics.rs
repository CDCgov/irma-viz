...
pub fn enabled_plots(p: &PlotsConfig) -> Vec<PlotKind> {
    let mut v = Vec::new();
...
pub fn render_svg_grid(path: &str, width: u32, height: u32, plots: &[PlotKind]) -> Result<()> {
...
fn line_data_1() -> Vec<(f64, f64)> {
    (0..200)
        .map(|i| (i as f64 / 10.0, (i as f64 / 42.0).sin()))
        .collect()
}
fn line_data_2() -> Vec<(f64, f64)> {
    (0..200)
        .map(|i| (i as f64 / 10.0, (i as f64 / 70.0).sin()))
        .collect()
}
fn line_data_3() -> Vec<(f64, f64)> {
    (0..200)
        .map(|i| (i as f64 / 10.0, (i as f64 / 32.0).sin()))
        .collect()
}
fn line_data_4() -> Vec<(f64, f64)> {
    (0..200)
        .map(|i| (i as f64 / 10.0, (i as f64 / 69.0).sin()))
        .collect()
}
fn hist_data_1() -> Vec<f64> {
    (0..2000)
        .map(|i| ((i as f64 * 0.01).sin() + 1.0) * 0.5)
        .collect()
}
fn hist_data_2() -> Vec<f64> {
    (0..2000)
        .map(|i| ((i as f64 * 0.02).sin() + 1.0) * 0.5)
        .collect()
}
